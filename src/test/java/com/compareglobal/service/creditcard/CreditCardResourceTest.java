...
import com.compareglobal.service.creditcard.CreditCardApplication;
import com.compareglobal.service.creditcard.CreditCardApplicationConfiguration;
...
public class CreditCardResourceTest {
    ...
    @ClassRule
    public static final DropwizardAppRule<CreditCardApplicationConfiguration> RULE =
            new DropwizardAppRule<>(CreditCardApplication.class, "myapp.yaml");
